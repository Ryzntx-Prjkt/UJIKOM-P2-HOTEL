...
@section('content')
    <a href="{{route('akun.show', $data->id)}}" class="btn btn-success">Kembali</a>
    <div class="card">
        ...
        <form action="{{route('akun.update', $data->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" required autofocus value="{{ $data->name }}">
                </div>
                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="password" class="form-control" autofocus autocomplete="current-password">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="c_password" class="form-label">Konfirmasi Password</label>
                            <input type="password" name="password_confirmation" id="c_password" class="form-control" autofocus>
                        </div>
                    </div>
                </div>
                <div class="form-group">
